...
Fr = TRUE #:1 # should the frescalo method be run - set to FALSE to bypass this
MM = TRUE #c(2,4) # should the Mixed model be run - set to FALSE to bypass this (about 50% of the total runtime excl Frescalo)
