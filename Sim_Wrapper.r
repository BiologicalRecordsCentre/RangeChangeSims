...
MM = FALSE #c(2,4) # should the Mixed model be run - set to FALSE to bypass this (about 50% of the total runtime excl Frescalo)
nr = 1 # Number of runs? ##SET AS 500##
